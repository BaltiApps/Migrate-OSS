...
class RestoreExternalDataUseCase(
    private val fileSystemSource: FileSystemSource,
    private val externalDataRestoreEngine: RestoreEngine<DataItem<AppListItem>>,
    private val dataRepository: RestoreDataRepository,
) {
    operator fun invoke(source: GenericFile): Flow<Progress> {
        ...
        return restoreEngineRunner(
            restoreEngine = externalDataRestoreEngine,
