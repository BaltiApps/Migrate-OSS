...
import balti.migrate.common.data.converter.AppDataItemAppSizeInfoExtractorImpl
...
val commonDiModule = module {
    ...
    single<AppDataItemAppSizeInfoExtractor<*>> {
        AppDataItemAppSizeInfoExtractorImpl()
    }
