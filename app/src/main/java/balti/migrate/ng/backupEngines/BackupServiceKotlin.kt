package balti.migrate.ng.backupEngines
...
import balti.migrate.ng.AppInstance.Companion.adbState
import balti.migrate.ng.AppInstance.Companion.appPackets
import balti.migrate.ng.AppInstance.Companion.callsList
import balti.migrate.ng.AppInstance.Companion.contactsList
import balti.migrate.ng.AppInstance.Companion.doBackupInstallers
import balti.migrate.ng.AppInstance.Companion.dpiText
import balti.migrate.ng.AppInstance.Companion.fontScale
import balti.migrate.ng.AppInstance.Companion.keyboardText
import balti.migrate.ng.AppInstance.Companion.sharedPrefs
import balti.migrate.ng.AppInstance.Companion.smsList
import balti.migrate.ng.AppInstance.Companion.wifiData
import balti.migrate.ng.AppInstance.Companion.zipBatches
import balti.migrate.ng.R
import balti.migrate.ng.backupEngines.containers.BackupIntentData
import balti.migrate.ng.backupEngines.containers.ZipAppBatch
import balti.migrate.ng.backupEngines.engines.*
import balti.migrate.ng.backupEngines.utils.OnEngineTaskComplete
import balti.migrate.ng.extraBackupsActivity.apps.containers.AppPacket
import balti.migrate.ng.extraBackupsActivity.calls.containers.CallsDataPacketsKotlin
import balti.migrate.ng.extraBackupsActivity.contacts.containers.ContactsDataPacketKotlin
import balti.migrate.ng.extraBackupsActivity.sms.containers.SmsDataPacketKotlin
import balti.migrate.ng.extraBackupsActivity.wifi.containers.WifiDataPacket
import balti.migrate.ng.simpleActivities.ProgressShowActivity
import balti.migrate.ng.utilities.CommonToolKotlin
import balti.migrate.ng.utilities.CommonToolKotlin.Companion.ACTION_BACKUP_CANCEL
import balti.migrate.ng.utilities.CommonToolKotlin.Companion.ACTION_BACKUP_PROGRESS
import balti.migrate.ng.utilities.CommonToolKotlin.Companion.ACTION_REQUEST_BACKUP_DATA
import balti.migrate.ng.utilities.CommonToolKotlin.Companion.ALL_SUPPRESSED_ERRORS
import balti.migrate.ng.utilities.CommonToolKotlin.Companion.CHANNEL_BACKUP_CANCELLING
import balti.migrate.ng.utilities.CommonToolKotlin.Companion.CHANNEL_BACKUP_END
import balti.migrate.ng.utilities.CommonToolKotlin.Companion.CHANNEL_BACKUP_RUNNING
import balti.migrate.ng.utilities.CommonToolKotlin.Companion.DEBUG_TAG
import balti.migrate.ng.utilities.CommonToolKotlin.Companion.ERR_BACKUP_SERVICE_ERROR
import balti.migrate.ng.utilities.CommonToolKotlin.Companion.ERR_BACKUP_SERVICE_INIT
import balti.migrate.ng.utilities.CommonToolKotlin.Companion.ERR_CONDITIONAL_TASK
import balti.migrate.ng.utilities.CommonToolKotlin.Companion.ERR_ON_COMPLETE_TASK
import balti.migrate.ng.utilities.CommonToolKotlin.Companion.EXTRA_BACKUP_NAME
import balti.migrate.ng.utilities.CommonToolKotlin.Companion.EXTRA_DESTINATION
import balti.migrate.ng.utilities.CommonToolKotlin.Companion.EXTRA_ERRORS
import balti.migrate.ng.utilities.CommonToolKotlin.Companion.EXTRA_IS_CANCELLED
import balti.migrate.ng.utilities.CommonToolKotlin.Companion.EXTRA_PROGRESS_PERCENTAGE
import balti.migrate.ng.utilities.CommonToolKotlin.Companion.EXTRA_PROGRESS_TYPE
import balti.migrate.ng.utilities.CommonToolKotlin.Companion.EXTRA_PROGRESS_TYPE_CALLS
import balti.migrate.ng.utilities.CommonToolKotlin.Companion.EXTRA_PROGRESS_TYPE_CONTACTS
import balti.migrate.ng.utilities.CommonToolKotlin.Companion.EXTRA_PROGRESS_TYPE_FINISHED
import balti.migrate.ng.utilities.CommonToolKotlin.Companion.EXTRA_PROGRESS_TYPE_SMS
import balti.migrate.ng.utilities.CommonToolKotlin.Companion.EXTRA_PROGRESS_TYPE_WAITING_TO_CANCEL
import balti.migrate.ng.utilities.CommonToolKotlin.Companion.EXTRA_TASKLOG
import balti.migrate.ng.utilities.CommonToolKotlin.Companion.EXTRA_TITLE
import balti.migrate.ng.utilities.CommonToolKotlin.Companion.EXTRA_TOTAL_TIME
import balti.migrate.ng.utilities.CommonToolKotlin.Companion.EXTRA_WARNINGS
import balti.migrate.ng.utilities.CommonToolKotlin.Companion.FILE_ERRORLOG
import balti.migrate.ng.utilities.CommonToolKotlin.Companion.FILE_PROGRESSLOG
import balti.migrate.ng.utilities.CommonToolKotlin.Companion.JOBCODE_PEFORM_BACKUP_CALLS
import balti.migrate.ng.utilities.CommonToolKotlin.Companion.JOBCODE_PEFORM_BACKUP_CONTACTS
import balti.migrate.ng.utilities.CommonToolKotlin.Companion.JOBCODE_PEFORM_BACKUP_SETTINGS
import balti.migrate.ng.utilities.CommonToolKotlin.Companion.JOBCODE_PEFORM_BACKUP_SMS
import balti.migrate.ng.utilities.CommonToolKotlin.Companion.JOBCODE_PEFORM_BACKUP_WIFI
import balti.migrate.ng.utilities.CommonToolKotlin.Companion.JOBCODE_PEFORM_SYSTEM_TEST
import balti.migrate.ng.utilities.CommonToolKotlin.Companion.JOBCODE_PERFORM_APP_BACKUP
import balti.migrate.ng.utilities.CommonToolKotlin.Companion.JOBCODE_PERFORM_APP_BACKUP_VERIFICATION
import balti.migrate.ng.utilities.CommonToolKotlin.Companion.JOBCODE_PERFORM_UPDATER_SCRIPT
import balti.migrate.ng.utilities.CommonToolKotlin.Companion.JOBCODE_PERFORM_ZIP_BACKUP
import balti.migrate.ng.utilities.CommonToolKotlin.Companion.JOBCODE_PERFORM_ZIP_BATCHING
import balti.migrate.ng.utilities.CommonToolKotlin.Companion.JOBCODE_PERFORM_ZIP_VERIFICATION
import balti.migrate.ng.utilities.CommonToolKotlin.Companion.NOTIFICATION_ID_CANCELLING
import balti.migrate.ng.utilities.CommonToolKotlin.Companion.NOTIFICATION_ID_FINISHED
import balti.migrate.ng.utilities.CommonToolKotlin.Companion.NOTIFICATION_ID_ONGOING
import balti.migrate.ng.utilities.CommonToolKotlin.Companion.PREF_COMPRESSION_LEVEL
import balti.migrate.ng.utilities.CommonToolKotlin.Companion.PREF_DEFAULT_COMPRESSION_LEVEL
import balti.migrate.ng.utilities.CommonToolKotlin.Companion.PREF_DELETE_ERROR_BACKUP
import balti.migrate.ng.utilities.CommonToolKotlin.Companion.PREF_SYSTEM_CHECK
import balti.migrate.ng.utilities.CommonToolKotlin.Companion.TIMEOUT_WAITING_TO_CANCEL_TASK
