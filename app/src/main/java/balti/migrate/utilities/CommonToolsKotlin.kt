...
class CommonToolsKotlin(val context: Context? = null) {
    ...
    companion object {
        ...
        val WARNING_MDP_PROGRESS_COPY = "MDP_PROGRESS_COPY"

        val ALL_WARNINGS = arrayOf(WARNING_ZIP_BATCH, WARNING_CALLS, WARNING_SMS, WARNING_ZIP_FILELIST_VERIFICATION,
                WARNING_ZIP_FILELIST_UNAVAILABLE, WARNING_ZIP_FILELIST_ITEM_UNAVAILABLE, WARNING_FILE_LIST_COPY, WARNING_MDP_PROGRESS_COPY)
