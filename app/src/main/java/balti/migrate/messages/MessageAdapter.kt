...
class MessageAdapter(private val context: Context,
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        try {
            v.message_item_title.text = json.getString(MESSAGE_FIELD_MESSAGE_TITLE)
            v.message_item_body.text = json.getString(MESSAGE_FIELD_MESSAGE_BODY)
            v.message_item_date.text = json.getString(MESSAGE_FIELD_DATE)
